...
import I4G from "../../../Assests/I4G.png";
  ...
  const handleSubmit = (event) => {
    ...
    return (
      <div id="wrapper">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="checkbox">
              ...
              <label htmlFor="checkbox" className="checkbox_span">
                You agree to providing your data to Casmir Michael who may contact you
              </label>
            </div>
        ...
        <footer>
          <img src={Vector} className="zuriLogo" alt="zuri__logo" />
          <h2>HNG Internship 9 Frontend Task</h2>
          <img src={I4G} alt="i4g__logo" />
        </footer>
      </div>
    );
  }
